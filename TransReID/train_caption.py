...
from processor import do_train_caption
import random
import torch
import numpy as np
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--config_file", default="configs/Market/vit_caption_maple_adain.yml", help="path to config file", type=str
    )
    ...
    test_logger = setup_logger("transreid.test", output_dir, if_train=False)
    test_logger.info("Test logger initialized :{}".format(cfg.OUTPUT_DIR))
