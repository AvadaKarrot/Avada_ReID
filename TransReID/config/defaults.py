...
_C.MODEL.BACKBONE.STATIC_POSITION_EMBEDDING = False
_C.MODEL.BACKBONE.PENULTIMATE_MAP_POOLER = False
_C.MODEL.BACKBONE.NAFLEX_MAX_NUM_PATCHES = 128
...
_C.OBJECTIVE.TRIPLET = CN()
_C.OBJECTIVE.TRIPLET.GATHER_ACROSS_RANKS = False
...
_C.OBJECTIVE.CAPTION.FEATURE_LEVEL = 'global'
_C.OBJECTIVE.CAPTION.USE_PROJECTION = True
_C.OBJECTIVE.CAPTION.PROJECTION_DIM = 512
_C.OBJECTIVE.CAPTION.TEMPERATURE = 0.07
_C.OBJECTIVE.CAPTION.POSITIVE_MODE = 'pid'
_C.OBJECTIVE.CAPTION.LOSS_TYPE = 'nce'
_C.OBJECTIVE.CAPTION.SIGMOID_REDUCTION = 'anchor'
_C.OBJECTIVE.CAPTION.SIGMOID_BIAS = -10.0
_C.OBJECTIVE.CAPTION.SIGMOID_LEARNABLE = True
_C.OBJECTIVE.CAPTION.GATHER_ACROSS_RANKS = False
_C.OBJECTIVE.ATTRIBUTE_CODEBOOK = CN()
_C.OBJECTIVE.ATTRIBUTE_CODEBOOK.ENABLED = False
_C.OBJECTIVE.ATTRIBUTE_CODEBOOK.WEIGHT = 0.0
_C.OBJECTIVE.ATTRIBUTE_CODEBOOK.START_EPOCH = 1
_C.OBJECTIVE.ATTRIBUTE_CODEBOOK.DECAY_START_EPOCH = 0
_C.OBJECTIVE.ATTRIBUTE_CODEBOOK.FINAL_WEIGHT = 0.0
_C.OBJECTIVE.ATTRIBUTE_CODEBOOK.CAPTION_FILE = ''
_C.OBJECTIVE.ATTRIBUTE_CODEBOOK.PHRASE_BANK = ''
_C.OBJECTIVE.ATTRIBUTE_CODEBOOK.CODEBOOK = ''
_C.OBJECTIVE.ATTRIBUTE_CODEBOOK.MANIFEST = ''
_C.OBJECTIVE.ATTRIBUTE_CODEBOOK.TEXT_TEMPERATURE = 0.07
_C.OBJECTIVE.ATTRIBUTE_CODEBOOK.IMAGE_TEMPERATURE = 0.07
_C.OBJECTIVE.ATTRIBUTE_CODEBOOK.MISSING_POLICY = 'error'
_C.OBJECTIVE.ATTRIBUTE_CODEBOOK.CONFIDENCE_WEIGHTING = True
_C.OBJECTIVE.ATTRIBUTE_RELATION = CN()
_C.OBJECTIVE.ATTRIBUTE_RELATION.ENABLED = False
_C.OBJECTIVE.ATTRIBUTE_RELATION.WEIGHT = 0.0
_C.OBJECTIVE.ATTRIBUTE_RELATION.START_EPOCH = 6
_C.OBJECTIVE.ATTRIBUTE_RELATION.TEMPERATURE = 0.1
_C.OBJECTIVE.ATTRIBUTE_RELATION.DOMAIN_KEY = 'dataset'
_C.OBJECTIVE.ATTRIBUTE_RELATION.QUEUE_SIZE = 256
_C.OBJECTIVE.ATTRIBUTE_RELATION.MAX_DOMAINS = 32
_C.OBJECTIVE.ATTRIBUTE_RELATION.MIN_CODE_MASS = 1.0
_C.OBJECTIVE.ATTRIBUTE_RELATION.MIN_EFFECTIVE_SAMPLES = 2.0
_C.OBJECTIVE.ATTRIBUTE_RELATION.MIN_ACTIVE_CODES = 3
_C.OBJECTIVE.ATTRIBUTE_RELATION.MIN_ANCHOR_CONFIDENCE = 0.0
